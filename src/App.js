...
import { Linkedin, Mail, GitBranch, GraduationCap, Briefcase, Smartphone, Gamepad2, ArrowRight, Sun, Moon, Shield, Wrench, Building2 } from 'lucide-react';
      ...
      <div className="container mx-auto">
        ...
        <Marquee baseVelocity={100}>
          {portfolioData.apps.map((app, index) => {
            ...
            const CardContent = (
              <div className="relative flex flex-col h-full bg-gray-50 dark:bg-slate-900 rounded-lg border border-gray-200 dark:border-slate-700 overflow-hidden">
