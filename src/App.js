...
const SectionTitle = ({ children }) => <h2 className="text-3xl md:text-4xl font-light text-center mb-12 md:mb-16 text-white"><ScrambleText>{children}</ScrambleText></h2>;
...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex flex-col items-center justify-center bg-black relative overflow-hidden">
      <AnimatedBackground />
      <div className="text-center px-6 z-10">
        <h1 className="text-5xl md:text-7xl font-light text-white tracking-tight">
          {displayedName}<span className={`${showCursor ? 'opacity-100' : 'opacity-0'} transition-opacity duration-300`}>|</span>
        </h1>
        <motion.p
