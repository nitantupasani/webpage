...
const portfolioData = {
  ...
  publications: [
    ...
    { text: "Upasani, N., Guerra-Santin, O., & Mohammadi, M. (2025). A self-determination theory approach to evaluating indoor environment satisfaction through building interfaces.", journal: "Energy Research & Social Science (under review)", link: "#", tags: ['User Satisfaction'] },
  ...
  return (
    <Section id="apps" className="bg-white dark:bg-slate-800">
      <div className="container mx-auto px-6">
        ...
        <div className="marquee">
          <div className="marquee-content">
            <div className="flex space-x-8 pb-4 -mx-6 px-6">
